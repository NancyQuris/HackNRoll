...
<form action="/answer" method = "POST" style="border:1px solid #ccc">
  <div class="container">
    ...
    <label for="Q1"><b>You consider yourself more practical than creative.</b></label><br>
    ...
    <label for="Q2"><b>People can rarely upset you.</b></label><br>
    ...
    <label for="Q3"><b>Your travel plans are usually well thought out.</b></label><br>
    ...
    <label for="Q4"><b>It is often difficult for you to relate to other people’s feelings.</b></label><br>
    ...
    <label for="Q5"><b>Your mood can change very quickly.</b></label><br>
    ...
    <label for="Q6"><b>You are usually highly motivated and energetic.</b></label><br>
    ...
    <label for="Q7"><b>You often feel as if you have to justify yourself to other people.</b></label><br>
    ...
    <label for="Q8"><b>Winning a debate matters less to you than making sure no one gets upset.</b></label><br>
    ...
    <label for="Q9"><b>Your home and work environments are quite tidy.</b></label><br>
    ...
    <label for="Q10"><b>You do not mind being at the center of attention.</b></label><br>
    ...
    <label for="Q11"><b>You find it easy to stay relaxed even when there is some pressure.</b></label><br>
    ...
    <label for="Q12"><b>You do not usually initiate conversations.</b></label><br>
    ...
    <label for="Q13"><b>You rarely do something just out of sheer curiosity.</b></label><br>
    ...
    <label for="Q14"><b>You feel superior to other people.</b></label><br>
    ...
    <label for="Q15"><b>Being organized is more important to you than being adaptable.</b></label><br>
    ...
    <label for="Q16"><b>You find it difficult to introduce yourself to other people.</b></label><br>
    ...
    <label for="Q17"><b>You often get so lost in thoughts that you ignore or forget your surroundings.</b></label><br>
    ...
    <label for="Q18"><b>You try to respond to your e-mails as soon as possible and cannot stand a messy inbox.</b></label><br>
